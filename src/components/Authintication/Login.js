...
const Login = () => {
    ...
    return (
        <div className='md:h-full h-[900px]'>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <Link
                                        to='/register'
                                        className="text-blue-600 hover:text-myBlue focus:text-blue-700 active:text-blue-800 duration-200 transition ease-in-out"
                                    >New user? Plz Register. </Link>
                                </div>

                                {/* <!-- Submit button --> */}
                                <button
                                    type="submit"
                                    className="inline-block px-7 py-3 bg-blue-600 text-white hover:text-myYellow font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-myBlue hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-full"
